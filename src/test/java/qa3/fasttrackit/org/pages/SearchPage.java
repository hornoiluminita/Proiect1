...
public class SearchPage extends PageObject {
    ...
    public void clickselectsearchButon() {
        clickOn(selectsearchButon);
    }

    public void setCheckProductWasFound() {
        checkProductWasFound.shouldContainText("Search Results for:");
    }
}
